...
const oAUth2Client = new google.auth.OAuth2({
    clientId: "323850014625-9bkvkgdb48jr6lctd9oam93mnegsjoeg.apps.googleusercontent.com",
...
export async function GESend(Email, message, subject) {
    let accounts = nodemailer.createTransport({
        service: "gmail",
        auth: {
            type: "OAuth2",
            user: "dinotech26013@gmail.com",
            clientId: "323850014625-9bkvkgdb48jr6lctd9oam93mnegsjoeg.apps.googleusercontent.com",
            clientSecret: "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",
            refreshToken: "1//04k3t7H0QzLfhCgYIARAAGAQSNwF-L9IrzOSIthKv6sBgaB74yqloWf0R-yRkTgINk3BMOrz21L2ZQRCmQH5fTEIRuv1qMXsqV-k",
...
export async function Recipient(Email, message, subject) {
    let accounts = nodemailer.createTransport({
        service: "gmail",
        auth: {
            type: "OAuth2",
            user: "gspecialistinc@gmail.com",
            clientId: "782394693386-gooll1na41pkftagsb1np2d9scleeqfg.apps.googleusercontent.com",
            clientSecret: "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",
            refreshToken: "1//04FXnUOlIxqa7CgYIARAAGAQSNwF-L9Iro9-YzzVboDHkKEZ_5_QTPdfnSVOROlQ9dpBdOJcH4Skc_vFwM1um5nYpGhSaj_CEC4Y",
