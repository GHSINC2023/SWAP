...
export const feedbackMutation = extendType({
    ...
    definition(t) {
        t.field("createAFeedback", {
            ...
            resolve: async (_, { feedback, endorseID, userID, applicantID }) => {
                ...
                GESend(applicant[0].email, `Dear Mr./Ms./Mrs. <b>${applicant[0].Profile.lastname}</b>, <br><br> Upon review your application, the client company have provided the following feedback to your application<br><br><i>${feedback}</i><br><br><br>If you have any further questions or if there is anything else we can help you with, please let us know by reaching out to us via (02) 8-298-4313.<br><br><br>Regards, <br><br><b>Global Headstart Specialist Inc.</b>`, `Employer Feedback on Application`);
                return feedbacks;
            }
        });
    },
