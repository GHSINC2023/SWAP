...
import Authorized from 'jsonwebtoken';
...
export const jobMutation = extendType({
    ...
    definition(t) {
        t.field("createAJobForRecruiter", {
            ...
            resolve: async (_, { userID, JobPost: { description, qualification, responsibilities, title }, JobDetails: { jobType, salary, location, category, workType } }, { req }) => {
                const token = req.cookies["ghs_access_token"];
                const { role } = verify(token, "HeadStart");
        ...
        t.field("createAJobForAMM", {
            ...
            resolve: async (_, { userID, JobPost: { title, description, qualification, responsibilities }, JobDetails: { location, salary, category, workType, jobType } }, { req }) => {
                const token = req.cookies["ghs_access_token"];
        ...
        t.field("updateJobPostStatus", {
            ...
            resolve: async (_, { jobPostID, status }, { req }) => {
                const token = req.cookies["ghs_access_token"];
        ...
        t.field("updateJobPost", {
            ...
            resolve: async (_, { jobPostID, JobPost: { description, qualification, responsibilities, title }, JobDetails: { jobType, location, salary, category, workType } }, { req }) => {
                const token = req.cookies["ghs_access_token"];
                const { userID, role } = verify(token, "HeadStart");
