import { extendType, stringArg, list, nonNull, intArg } from 'nexus';
...
export const jobDetialsQuery = extendType({
    ...
    definition(t) {
        ...
        t.list.field("getSpecificJob", {
            ...
            resolve: async (_, { category, jobType, workType, limit, offset }) => {
                if (category) {
        ...
        t.list.field("getJobRelated", {
            ...
            resolve: async (_, { category, limit, offset }) => {
                return await prisma.jobDetails.findMany({
                    where: {
                        category,
                        JobPost: {
