...
export const screeningMutation = extendType({
    ...
    definition(t) {
        t.field("createScreening", {
            ...
            resolve: async (_, { applicantID, start, end, userID }) => {
