...
export const applicaitonMutation = extendType({
    ...
    definition(t) {
        t.field("createApplication", {
            ...
            resolve: async (_, { jobPostID, email, Profile: { birthday, lastname, firstname, phone }, Address: { city, province, street, zipcode }, file, video }) => {
        ...
        t.field("updateApplicantStatus", {
            ...
            resolve: async (_, { applicantID, status, userID }) => {
                ...
                if (status === "declined") {
                    ...
                    GESend(app.email, `Dear Mr./Ms./Mrs <b>${app.Profile.lastname}</b>,<br><br>Thank you for applying for the <b>${app.JobPost.title}</b> position. After carefully and thoroughly evaluating a significant number of applications, we have to inform you that we won’t be able to invite you to the next stage of the hiring process at this time. Despite your impressive resume, we have decided to move forward with a candidate whose qualifications are better suited for this particular position. 
                    <br><br>Please be informed that you will not be able to apply for another position for the <b>next thirty (30) days</b>.<br><br>Once again, thank you so much for taking the time to apply. We wish you the best of luck and much success in your future endeavors.<br><br><br>If you have any further questions or if there is anything else we can help you with, please let us know by reaching out to us via (02) 8-298-4313.<br><br><br>Regards,<br><br><b>Global Headstart Specialist Inc.</b>`, "Application Declined");
                    return app;
                }
            }
        });
        ...
        t.field("viewMyApplication", {
            ...
            resolve: async (_, { email, id }, { res }) => {
                ...
                if (!findId)
                    throw new GraphQLError("Invalid Applicant No.");
        ...
        t.list.field("generateApplicantCSV", {
            ...
            resolve: async (_, { status, start, end, order }) => {
